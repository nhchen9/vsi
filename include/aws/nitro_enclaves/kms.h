...
struct aws_kms_encrypt_response {
    /**
     * ARN of the key used to perform the encryption. This value is returned if no errors are
     * encountered during the operation.
     *
     * Required: Yes.
     */
    ...
    /**
     * Encrypted data. This value may not be returned if the customer master key is
     * not available or if you didn't have permission to use it.
     *
     * Required: No.
     */
    ...
    /**
     * The encryption algorithm that was used to encrypt the ciphertext.
     *
     * Required: No.
     */
    enum aws_encryption_algorithm encryption_algorithm;
